 ...
 */
final class Version20191022204221 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE clientes ADD telefono VARCHAR(80) NOT NULL, CHANGE email email VARCHAR(60) DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE blog_post CHANGE created_at created_at DATETIME NOT NULL');
        $this->addSql('ALTER TABLE clientes DROP telefono, CHANGE email email VARCHAR(60) DEFAULT \'NULL\' COLLATE utf8mb4_unicode_ci');
